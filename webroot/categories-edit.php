...
if (mh_request_is_method("GET")) {
    ...
    $edited_category = [
        ...
        "parent_id" => mh_request_get_int_parameter("parent_id", INPUT_POST, 1, PHP_INT_MAX, 0),
    ];

    $errors["name"] = mh_validate_category_name($edited_category["name"], "name");
    $errors["parent_id"] = $edited_category["parent_id"] === 0 ? "parent category is required" : null;
